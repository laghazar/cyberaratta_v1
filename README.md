...
- **Ֆայլերի վերբեռնում** - Ապացույցների և էկրանահանքների պահպանում
- **Վնասի գնահատում** - Ֆինանսական, տվյալների, հոգեբանական վնաս
- **Արտակարգ կապեր** - Ընդլայնված կոնտակտային տվյալներ
...
## 🏆 Հեղինակներ և Գիտակցում

- **Հիմնական ծրագրավորող:** [Laghazar](https://github.com/laghazar)
- **UI/UX Դիզայն:** CyberAratta թիմ
- **Անվտանգության խորհուրդ:** Հայաստանի կիբեռանվտանգության մասնագետներ

## 📞 Օգնություն և Աջակցություն

- **Էլ. փոստ:** support@cyberaratta.am
- **GitHub Issues:** [Issues](https://github.com/laghazar/cyberaratta_v1/issues)
- **Դոկումենտացիա:** [Wiki](https://github.com/laghazar/cyberaratta_v1/wiki)
